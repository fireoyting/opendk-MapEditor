...
//
//
// - ThingFramePack    : 没有方向的表达事物
// - EffectFramePack   : 表达各方向效果
// - CreatureFramePack : 用动作和方向表达生物
//
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
// 保存生物框架包文件
// 您还必须保存 Creature Frame Pack 索引文件。
//----------------------------------------------------------------------
template <class Type>
bool
